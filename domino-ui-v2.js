  ...
  function installCreditChain(){
    ...
    if(g){
      g.innerHTML=`
        ...
        <div class="card"><div class="name">Kreditklemme</div><div class="light" style="background:var(--yellow)"><span class="statusword">GELB</span></div><div class="price">Private Credit</div><div class="small">Rücknahmedruck · Standards · Spreads</div></div>
    ...
    if(body&&!document.getElementById('creditChainRules')){
      const box=document.createElement('div');box.id='creditChainRules';box.innerHTML=`<div class="detailtitle">Kredit- und Reparaturkette · Version 1.1</div><div class="rule"><b>Kausalkette</b><br>Energie-/Dieselstress → höheres Working Capital und schwächere Margen → Liquiditätsverbrauch → Kreditausfälle → höhere NPL/Stage-2-Risiken → strengere Kreditstandards und höhere Risikoprämien → weniger Ersatzinvestitionen.</div><div class="rule"><b>Private Credit · Rücknahmedruck</b><br>DOMINO beobachtet nicht nur tatsächliche Fondsabflüsse, sondern den Druck dahinter: Rücknahmeanträge im Verhältnis zu den erlaubten Rücknahmen. Wollen deutlich mehr Anleger heraus, als ein Fonds auszahlt, kann der sichtbare Nettoabfluss den Vertrauensverlust unterschätzen. Das ist ein Frühwarnsignal für eine mögliche Kreditverknappung, noch kein Systembruch.</div><div class="rule"><b>Kreditklemme · Ampellogik</b><br>🟢 normaler Kreditfluss · 🟡 merklicher Rücknahmedruck oder strengere Standards/Spreads · 🟠 Rücknahmedruck plus deutlich weniger Refinanzierung/Neukredite · 🔴 selbstverstärkende Kredit- und Liquiditätsklemme mit Zwangsverkäufen oder breiten Finanzierungsausfällen.</div><div class="rule"><b>Zinsregel</b><br>Ein Energiepreisschock kann Inflationsdruck und damit höhere oder länger hohe Leitzinsen erzeugen. Bei schwerer Rezession können Leitzinsen zugleich fallen. Für DOMINO zählt deshalb zusätzlich der Kreditspread: Firmen können trotz sinkendem Leitzins teurer oder gar nicht mehr finanzierbar sein.</div><div class="rule"><b>Rückkopplung</b><br>Ausfälle drücken Sicherheitenwerte und Bankrisikobudgets. Banken und Kreditfonds begrenzen neue Kredite gerade in den Branchen, in denen Ersatzkapazität benötigt wird. Damit kann die normale Selbstheilung des Marktes blockiert werden.</div><div class="alarm"><b style="color:var(--text)">DOMINO-Reparaturtest</b><br>Der entscheidende Systemtest lautet: Kann ein gesunder Betreiber die ausgefallene Kapazität kaufen, bauen und finanzieren? Wenn die Antwort über längere Zeit nein ist, wird aus einem Preisschock ein struktureller Schaden.</div>`;body.appendChild(box);
    }
  }
